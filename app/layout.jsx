  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <header className="bg-gray-900/90 text-white sticky top-0 z-50 shadow-md backdrop-blur-sm">
          <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="/" className="text-2xl font-bold nav-link">
              Manzi
            </a>
            <div className="space-x-6">
              <a href="#about" className="hover:text-gray-300 nav-link">
                About
              </a>
              <a href="#services" className="hover:text-gray-300 nav-link">
                Services
              </a>
              <a href="#contact" className="hover:text-gray-300 nav-link">
                Contact
              </a>
            </div>
          </nav>
        ...
        <footer className="bg-gray-900/95 text-white py-4 text-sm">

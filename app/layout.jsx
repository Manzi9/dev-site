  ...
  return (
    <html lang="en" className="dark scroll-smooth">
      <body className={`${inter.className} bg-gray-950 text-gray-200`}>
        <header className="bg-black/60 text-white sticky top-0 z-50 backdrop-blur-sm">
          <div className="container mx-auto px-6 py-4">
            <nav className="flex justify-between items-center">
              <a href="/" className="text-2xl nav-link tracking-wider">
                <span className="text-white font-light">MANZI</span>
